...
public class FogDevice extends PowerDatacenter {
	public static enum DeviceNodeType {
		FogNode, FogControllerNode, NeighboringFogControllerNode, CloudNode
	}
	...
	public DeviceNodeType getDeviceNodeType() {
		...
		if (this.getLevel() > 1 && ((childrenIds == null || childrenIds.isEmpty()) || //
				(childToOperatorsMap == null || childToOperatorsMap.isEmpty()) || //
				(childToLatencyMap == null || childToLatencyMap.isEmpty()) //
		)) {
			return DeviceNodeType.FogNode;
		}

		// TODO: almost arbitrarly choosen tests .. inspired from DCNSFog test class

		if (getName().startsWith("d-")) {
			return DeviceNodeType.FogControllerNode;
		}

		if (this.getLevel() == 1 || getName().contains("server") || getName().contains("proxy")) {
			return DeviceNodeType.NeighboringFogControllerNode;
		}
